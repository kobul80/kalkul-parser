...
/* modifed TemplpateCrationException to SystemException by Lubos Lipinsky */
...
public class Template{
     ...
     * @exception Exception If can't create Template
     */
    public Template(String pathname) throws Exception {
     ...
     * @exception Exception If can't create Template
     */
    public Template(BufferedReader reader) throws Exception {
        String line;
        while ((line = reader.readLine()) != null){
            ...
            if ((match = line.indexOf("<t:")) != -1){
                ...
                if (!variables.containsKey(template.closeTag))
                    throw new Exception("TEMPLATE_CREATION_ERROR");
    ...
    public Template clear(){
        ...
        while(iterator.hasNext())
            variables.put(iterator.next(), new StringBuffer());
